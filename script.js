...
//API
const API_ENDPOINT='http://api.weatherstack.com/current?access_key=${access_key}&query=${location}';
let isRequestInProgress = false;
 ...
 const cleanupResponse =() => {
  ...
  const showAnswer = answer => {
    setTimeout(() => {
        answerSelector.innerHTML = '<img src=\"${answer}\" width=\"600px\"heigth=\"400px\">';
        cleanupResponse();
  },3000)
  };
